    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          ...
          <h2 data-aos="fade-up" data-aos-delay="400">A simple PHP WebChat that use's an internal API to manage messages/users, called using AxiosJS. The used database is MariaDB.</h2>
          <div data-aos="fade-up" data-aos-delay="600">
            <div class="text-center text-lg-start">
              <a href="login/login.php" class="btn-get-started scrollto d-inline-flex align-items-center justify-content-center align-self-center">
                <span>Login</span>
